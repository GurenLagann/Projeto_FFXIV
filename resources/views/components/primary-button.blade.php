<button {{ $attributes->merge(['type' => 'submit']) }}
    style="font-family:'Cinzel',Georgia,serif;font-size:0.7rem;letter-spacing:0.14em;text-transform:uppercase;background:linear-gradient(160deg,#141440 0%,#1e1e60 100%);border:1px solid #f0c030;color:#f0c030;padding:0.55rem 1.2rem;cursor:pointer;transition:background 120ms ease,color 120ms ease,border-color 120ms ease,box-shadow 120ms ease;display:inline-flex;align-items:center;gap:0.4rem;white-space:nowrap;"
