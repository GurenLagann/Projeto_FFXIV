<button {{ $attributes->merge(['type' => 'submit']) }}
    style="font-family:'Cinzel',Georgia,serif;font-size:0.7rem;letter-spacing:0.14em;text-transform:uppercase;background:linear-gradient(160deg,#2a0808 0%,#4a1010 100%);border:1px solid #ff5533;color:#ff5533;padding:0.55rem 1.2rem;cursor:pointer;transition:all 120ms ease;display:inline-flex;align-items:center;gap:0.4rem;white-space:nowrap;"
